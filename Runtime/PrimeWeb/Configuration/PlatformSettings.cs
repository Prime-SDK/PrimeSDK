...
namespace PrimeGames.SDK.PrimeWeb
{
    ...
    public class PlatformSettings
    {
        ...
        [SerializeField] public Y8New_PropertyGroup y8New;
        ...
        [SerializeField] public LaggedNew_PropertyGroup laggedNew;
        ...
        public PlatformSettings()
        {
            ...
            laggedNew = new LaggedNew_PropertyGroup();
        ...
        public PlatformSettings(PreferencesReader preferencesReader)
        {
            ...
            y8New = preferencesReader.GetPropertyGroup<Y8New_PropertyGroup>(configurationName);
            ...
            laggedNew = preferencesReader.GetPropertyGroup<LaggedNew_PropertyGroup>(configurationName);
            ...
            poki = preferencesReader.GetPropertyGroup<Poki_PropertyGroup>(configurationName);
        }
